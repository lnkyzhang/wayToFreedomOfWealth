...
class St(bt.Strategy):
    ...
    def next(self):
        ...
        txt += '%04d, %04d' % (len(self.data0), len(self.data1))
...
def runstrat():
    ...
    cal_date = sse.schedule(start_date=fromdate, end_date=todate)

    if args.filler or args.filler0:
        data0.addfilter(WeekDaysFiller, cal_date, fillclose=args.fillclose)

    if args.filler or args.filler1:
        data1.addfilter(WeekDaysFiller, cal_date, fillclose=args.fillclose)
